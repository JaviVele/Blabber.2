...
module.exports = {
    crear: async function (req, res) {
      ...
      listar: async function (req, res) {
        ...
        try {
          const mensajes = await Mensaje.find({id_usuario_envia: id, id_usuario_recibe: usuarioId}).populate("id_usuario_recibe");
          const mensajesRecibidos = await Mensaje.find({ id_usuario_recibe: id, id_usuario_envia: usuarioId }).populate("id_usuario_recibe");
